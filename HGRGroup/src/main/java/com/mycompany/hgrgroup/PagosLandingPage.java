 ...
 * @author Familia
 */
public class PagosLandingPage extends javax.swing.JFrame {
     ...
     */
    public PagosLandingPage(SharedData data, String nombreCliente) {
        initComponents();
        this.shareData = data;
    ...
    private void initComponents() {
        ...
        label4.setText("PAGOS");
        jPanel4.add(label4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 230, -1, 20));
    ...
    private void mostrarPagos(){   
        ...
        for(int i = 0; i < shareData.getClientes().size(); i++){
            if(shareData.getClientes().get(i).getNombreCliente().equals(cliente)){
                for(int k = 0; k < shareData.getClientes().get(i).getPagosRealizados().size(); k++){

                    String [] row = new String[5];
                    row[0] = String.valueOf(shareData.getClientes().get(i).getPagosRealizados().get(k).getIdentificador());
                    row[1] = String.valueOf(shareData.getClientes().get(i).getPagosRealizados().get(k).getCantidad());
                    row[2] = shareData.getClientes().get(i).getPagosRealizados().get(k).getEstadoPago();
                    row[3] = shareData.getClientes().get(i).getPagosRealizados().get(k).getMetodoPago();
                    row[4] = shareData.getClientes().get(i).getPagosRealizados().get(k).getFechaPago();
                    modelo.addRow(row);
    ...
    private void ajustarTamanoColumnaDescripcion() {
        TableColumn columnaDescripcion = jTablaModificaciones.getColumnModel().getColumn(getColumnIndex("Monto"));
        int ancho = 0;
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        // TODO add your handling code here:
        AgregarPagos pagModi = new AgregarPagos(getSharedData(), cliente);
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
        ...
        ClientesLandingPage casasPage = new ClientesLandingPage(getSharedData());
        this.setVisible(false);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try{
            ...
            ModificarPago modiPage = new ModificarPago(getSharedData(), (String) valor, cliente); //Convierto valor a String
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(fila >= 0){
            ...
            for(int i = 0 ; i < shareData.getCasas().size();i++){
                if(shareData.getClientes().get(i).getNombreCliente().equals(cliente)){
                    shareData.getClientes().get(i).getPagosRealizados().remove(fila);
                }
            }
        }else{
