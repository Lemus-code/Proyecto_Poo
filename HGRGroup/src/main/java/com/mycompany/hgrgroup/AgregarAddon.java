 ...
 * @author uriel
 */
public class AgregarAddon extends javax.swing.JFrame {
     ...
     */
    public AgregarAddon(SharedData sharedData, String cliente) {
        initComponents();
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
        AddonsLandingPage modiPage = new AddonsLandingPage(getSharedData(), cliente);
         ...
         try {
            if (txtFieldNombre.getText().isEmpty() || txtFieldEstado.getText().isEmpty() || txtFieldInicio.getText().isEmpty() || txtFieldFin.getText().isEmpty() || txtFieldDescri.getText().isEmpty() || txtFieldAdicional.getText().isEmpty()  ) {
                ...
                try {
                    ...
                    Addons addon = new Addons(nombre, descripcion, estado, dateInicio, dateFin, costoAdicional);
                    JOptionPane.showMessageDialog(null, "El addon se agregó exitosamente", "Addon Agregado",JOptionPane.INFORMATION_MESSAGE);
                    for(int i = 0; i < sharedData.getCasas().size(); i++){
                        if(sharedData.getCasas().get(i).getNombreCliente().equals(cliente)){
                            sharedData.getCasas().get(i).getAddons().add(addon);
                        };
                    };
